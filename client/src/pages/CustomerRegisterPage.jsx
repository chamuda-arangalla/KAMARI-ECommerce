    ...
    <div className="min-h-screen flex font-['Poppins']">
      ...
      <div className="hidden lg:block lg:w-[40%] xl:w-[45%] sticky top-0 h-screen flex-shrink-0 overflow-hidden">
        ...
        <div className="absolute top-8 left-8 right-8 flex items-center justify-between z-10">
          <Link to="/" className="text-lg font-light tracking-[0.35em] text-white">
            KAMARI
          </Link>
          <span className="text-[9px] tracking-[0.22em] text-white/50 uppercase">Est. 2024</span>
        </div>
        ...
        <div className="absolute bottom-8 left-8 right-8 z-10 space-y-3">
          ...
          <p className="text-[11px] text-white/50 tracking-[0.18em] uppercase">
          ...
          <div className="inline-flex items-center border border-white/20 rounded-lg px-4 py-2 bg-white/5 backdrop-blur-sm">
            <span className="text-[11px] text-white/60 tracking-wide">Free delivery across Sri Lanka</span>
          </div>
        </div>
      </div>
        ...
        <div className="min-h-full flex items-center justify-center px-8 xl:px-14 py-12">
          <div className="w-full max-w-xl">
            ...
            <div className="lg:hidden text-center mb-8">
              <Link to="/" className="text-2xl font-light tracking-[0.25em] text-[#3B302A]">KAMARI</Link>
            </div>

            {/* Heading */}
            <div className="mb-8">
              <h1 className="text-2xl font-semibold text-[#3b302a]">Create your account</h1>
              <p className="text-sm text-[#a3948b] mt-1">Fill in your details to get started</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div className="space-y-3 pb-4">
                ...
                <p className="text-center text-sm text-[#a3948b]">
                  ...
                  <Link to="/login" className="text-[#3b302a] underline underline-offset-2">Sign in</Link>
                </p>
              </div>
...
const SectionTitle = ({ children }) => (
  <h3 className="text-xs font-semibold text-[#a3948b] uppercase tracking-wider border-b border-[#e5ddd5] pb-2">
    {children}
  </h3>
);
...
const Field = ({ label, required = false, ...props }) => (
  <div>
    <label className="block text-xs font-semibold text-[#a3948b] uppercase tracking-wider mb-1.5">
      {label}
    </label>
    <input
      required={required}
