        ...
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={mockAnalytics.revenueData}>
              ...
              <XAxis dataKey="name" axisLine={false} tickLine={false} tick={{ fill: '#a3948b', fontSize: 14 }} dy={10} />
              <YAxis axisLine={false} tickLine={false} tick={{ fill: '#a3948b', fontSize: 14 }} />
              <Tooltip contentStyle={{ backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #e5ddd5', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', fontSize: 14 }} />
        ...
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={mockAnalytics.bestSellers} layout="vertical">
              ...
              <YAxis dataKey="name" type="category" axisLine={false} tickLine={false} tick={{ fill: '#3b302a', fontSize: 14 }} width={130} />
              <Tooltip cursor={{ fill: '#fcfaf7' }} contentStyle={{ backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #e5ddd5', fontSize: 14 }} />
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={idx} className="space-y-2">
              ...
              <div className="h-2.5 w-full bg-[#f8f5f2] rounded-full overflow-hidden">
