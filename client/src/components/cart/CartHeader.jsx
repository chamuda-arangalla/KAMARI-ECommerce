...
export default function CartHeader({ totalItems }) {
  return (
    <>
      {/* Top Bar */}
      <div className="bg-[#3B302A] text-[#F8F5F2] text-center py-2.5 text-sm tracking-[0.18em] font-medium mt-16">
      ...
      <div className="border-b border-[#3B302A]/10 bg-[#F8F5F2]">
        <div className="max-w-6xl mx-auto px-6 py-8 flex items-baseline justify-between">
          ...
          <h1 className="text-3xl font-light tracking-[0.18em] text-[#3B302A] uppercase">
            Shopping Bag
          </h1>

          <span className="text-base text-[#7D746C] tracking-[0.18em]">
