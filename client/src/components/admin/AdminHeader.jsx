      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-[#3b302a]">Elena Kamari</p>
          ...
          <button className="p-2 text-[#6b5e55] hover:text-[#3b302a] hover:bg-[#f8f5f2] rounded-full transition-all">
            <LogOut size={20} />
          </button>
        </div>
      </div>
